...
class JDLField {
  constructor(args) {
    ...
    this.ifPrimaryKey = merged.ifPrimaryKey;
    this.ifListView = merged.ifListView;
    this.ifQueryCriteria = merged.ifQueryCriteria;
    this.quoteType = merged.quoteType;
    this.quoteCode = merged.quoteCode;
  }
