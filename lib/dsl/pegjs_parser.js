  ...
  (function() {
    ...
    function peg$parse(input, options) {
      ...
      var peg$FAILED = {},
        ...
        peg$c21 = function(jd, e, tableName, eb, eabs) {
          return addUniqueElement({ name: e, tableName: tableName ? tableName: e, body: eb, javadoc: jd},eabs);
        },
        peg$c22 = function(e, eb, eabs) { return addUniqueElement({ name: e, body: eb, javadoc: ''},eabs);; },
        peg$c23 = "(",
        ...
        peg$c81 = function() { return { key: 'ifPrimaryKey', value: true }; },
        ...
        peg$c94 = function(string) { return { key: 'quoteType', value: string };},
        peg$c95 = function(string) { return { key: 'quoteCode', value: string };},
        peg$c96 = function(regex) { return { key: 'pattern', value: regex }; },
        peg$c97 = function(string) { return { dbName: string };},
        peg$c98 = function(string) { return { cacheType: string };},
        peg$c99 = function(string) { return { entityPath: string };},
        ...
        peg$c109 = "entity",
        peg$c110 = peg$literalExpectation("entity", false),
        peg$c111 = "relationship",
        peg$c112 = peg$literalExpectation("relationship", false),
        peg$c113 = "enum",
        peg$c114 = peg$literalExpectation("enum", false),
        peg$c115 = "OneToOne",
        peg$c116 = peg$literalExpectation("OneToOne", false),
        peg$c117 = "OneToMany",
        peg$c118 = peg$literalExpectation("OneToMany", false),
        peg$c119 = "ManyToOne",
        peg$c120 = peg$literalExpectation("ManyToOne", false),
        peg$c121 = "ManyToMany",
        peg$c122 = peg$literalExpectation("ManyToMany", false),
        peg$c123 = "all",
        peg$c124 = peg$literalExpectation("all", false),
        peg$c125 = "*",
        peg$c126 = peg$literalExpectation("*", false),
        peg$c127 = "with",
        peg$c128 = peg$literalExpectation("with", false),
        peg$c129 = "except",
        peg$c130 = peg$literalExpectation("except", false),
        peg$c131 = "noFluentMethod",
        peg$c132 = peg$literalExpectation("noFluentMethod", false),
        peg$c133 = "dto",
        peg$c134 = peg$literalExpectation("dto", false),
        peg$c135 = "paginate",
        peg$c136 = peg$literalExpectation("paginate", false),
        peg$c137 = "service",
        peg$c138 = peg$literalExpectation("service", false),
        peg$c139 = "microservice",
        peg$c140 = peg$literalExpectation("microservice", false),
        peg$c141 = "search",
        peg$c142 = peg$literalExpectation("search", false),
        peg$c143 = "skipClient",
        peg$c144 = peg$literalExpectation("skipClient", false),
        peg$c145 = "skipServer",
        peg$c146 = peg$literalExpectation("skipServer", false),
        peg$c147 = "angularSuffix",
        peg$c148 = peg$literalExpectation("angularSuffix", false),
        peg$c149 = "filter",
        peg$c150 = peg$literalExpectation("filter", false),
        peg$c151 = "minlength",
        peg$c152 = peg$literalExpectation("minlength", false),
        peg$c153 = "maxlength",
        peg$c154 = peg$literalExpectation("maxlength", false),
        peg$c155 = "minbytes",
        peg$c156 = peg$literalExpectation("minbytes", false),
        peg$c157 = "maxbytes",
        peg$c158 = peg$literalExpectation("maxbytes", false),
        peg$c159 = "max",
        peg$c160 = peg$literalExpectation("max", false),
        peg$c161 = "min",
        peg$c162 = peg$literalExpectation("min", false),
        peg$c163 = "pattern",
        peg$c164 = peg$literalExpectation("pattern", false),
        peg$c165 = "primaryKey",
        peg$c166 = peg$literalExpectation("primaryKey", false),
        peg$c167 = "quoteType",
        peg$c168 = peg$literalExpectation("quoteType", false),
        peg$c169 = "quoteCode",
        peg$c170 = peg$literalExpectation("quoteCode", false),
        peg$c171 = "dbName",
        peg$c172 = peg$literalExpectation("dbName", false),
        peg$c173 = "cacheType",
        peg$c174 = peg$literalExpectation("cacheType", false),
        peg$c175 = "entityPath",
        peg$c176 = peg$literalExpectation("entityPath", false),
        peg$c177 = /^[^\n\r\/]/,
        ...
        peg$c187 = /^[A-Z_]/,
        peg$c188 = peg$classExpectation([["A", "Z"], "_"], false, false),
        peg$c189 = "-",
        peg$c190 = peg$literalExpectation("-", false),
        peg$c191 = /^[0-9]/,
        peg$c192 = peg$classExpectation([["0", "9"]], false, false),
        peg$c193 = function(negative, int) { return parseInt(`${(negative ? negative : '') + int.join('')}`, 10); },
        peg$c194 = /^[a-zA-Z]/,
        peg$c195 = peg$classExpectation([["a", "z"], ["A", "Z"]], false, false),
        peg$c196 = /^[A-z0-9()]/,
        peg$c197 = peg$classExpectation([["A", "z"], ["0", "9"], "(", ")"], false, false),
        peg$c198 = /^['\n'|'\t'|'\r'|' '|\u2028|\u2029]/,
                    ...
                    if (s7 !== peg$FAILED) {
                      ...
                      if (s8 !== peg$FAILED) {
                        ...
                        if (s9 !== peg$FAILED) {
                          ...
                          if (s10 !== peg$FAILED) {
                            s11 = peg$parseextendedAttributeList();
                            if (s11 === peg$FAILED) {
                              s11 = null;
                            }
                            if (s11 !== peg$FAILED) {
            ...
            if (s2 !== peg$FAILED) {
              ...
              if (s3 !== peg$FAILED) {
                ...
                if (s4 !== peg$FAILED) {
                  ...
                  if (s5 !== peg$FAILED) {
                    s6 = peg$parseextendedAttributeList();
                    if (s6 === peg$FAILED) {
                      s6 = null;
                    }
                    if (s6 !== peg$FAILED) {
      ...
      function peg$parseextendedAttributeList() {
        var s0, s1, s2, s3;
        ...
        if (s1 !== peg$FAILED) {
          ...
          if (s2 !== peg$FAILED) {
            s3 = peg$parseextendedAttributeList();
            if (s3 !== peg$FAILED) {
              peg$savedPos = s0;
              s1 = peg$c39(s1, s3);
              s0 = s1;
      ...
      function addUniqueElement(v1, array2) {
        if (v1) {
          if (array2) {
